...
It seems that the above proof of Theorem~\ref{2017a6-3} can be generalized a bit, to the case where $F$ is a commutative local ring of characteristic $2$.
Check if the characteristic assumption can be lifted to residue characteristic (i.e. only that $R/\mathfrak{m}$ has characteristic $2$).
While hard, you might also want to check if commutativity is needed.
