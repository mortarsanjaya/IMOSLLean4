...
If $f(-1) = 0$ is allowed, then the difficulty level rises to A6.
Note that Cauchy's functional equation ($f(x + y) = f(x) + f(y)$) is well-known nowadays.
...
\subsubsection*{Step 1: Small observations}
...
\subsubsection*{Step 2: Ring quotients}
...
\subsubsection*{Step 3: Case 1: $f(-1) \neq 0$}
...
\subsubsection*{Step 4: Subcase 1.1: $f(-1) = -2 \neq 0$}
...
\subsubsection*{Step 5: Subcase 1.2: $f(-1) = 1 \neq -2$}
...
\subsubsection*{Step 6: Case 2: $f(-1) = 0$}
...
\subsubsection*{Step 7: Subcase 2.1: $f(2) = 0 \neq 3$}
...
\subsubsection*{Step 8: Subcase 2.2: $f(2) = 1 \neq -1$}
...
\subsubsection*{Step 9: Subcase 2.3: $f(2) = 3 \neq 1$}
...
\subsubsection*{Step 10: Subcase 2.4: $f(2) = -1$}
...
For any $x \in R$, we have either
\begin{itemize}
    \item   $f(x) f(x + 1) = 0$; or
    \item   $f(x) + f(x + 1) = 1$ and $f(x) f(x + 1) = -1$.
\end{itemize}
\end{lemma}
\begin{proof}
...
\begin{itemize}
    \item   $x^2 = 0$;
    \item   $(x + 1)^2 = 0$; or
    \item   $f(x) + f(x + 1) = 1$ and $x^2 + x + 1 = 0$.
\end{itemize}
\end{lemma}
\begin{proof}
