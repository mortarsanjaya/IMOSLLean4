...
This project depends on [Mathlib4](https://github.com/leanprover-community/mathlib4) and is currently using version **4.34.0-rc2**.
...
Below are some statistics on the number of problems formalized in this repository as of **September 7, 2026**.
